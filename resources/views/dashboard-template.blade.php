<x-app-layout>
    ...
    <div class="mt-6" style="margin-top: 6rem">
        <div class="grid grid-cols-1 gap-6 mb-6 mt-9 w-full xl:grid-cols-2 2xl:grid-cols-3">
            <!-- Total Appointments Card -->
            @include('livewire.dashboards.partials.reception.metrics.total-appointments')
            <!-- Scheduled Appointments Card -->
            @include('livewire.dashboards.partials.reception.metrics.scheduled-appointments')

            <!-- Completed Appointments Card -->
            @include('livewire.dashboards.partials.reception.metrics.completed-appointments')

            <!-- New Patients Card -->
            @include('livewire.dashboards.partials.reception.metrics.new-patients')

            <!-- Total Patients Card -->
            @include('livewire.dashboards.partials.reception.metrics.total-patients')

        </div>

        <div class="px-4 pt-6 mt-6">
                            ...
                            <footer class="flex items-center justify-between mb-2">
                                <div class="flex items-center">
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-400">
                                        <time pubdate datetime="2022-02-08" title="February 8th, 2022"> 01/03/2023 4:15
                                            PM
                                        </time>
                                    </p>
                                </div>
                  ...
                  4%
                            ...
                            <div>
                                <svg class="w-8 h-8 mb-1 text-gray-500 dark:text-gray-400" fill="currentColor"
                                     viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                    <path
                                        d="M8 16.25a.75.75 0 01.75-.75h2.5a.75.75 0 010 1.5h-2.5a.75.75 0 01-.75-.75z"></path>
                                    <path clip-rule="evenodd" fill-rule="evenodd"
                        ...
                        <div class="relative mx-auto overflow-hidden h-[36rem] lg:h-[24rem]">
                            ...
                            <div class="hidden duration-700 ease-in-out bg-white dark:bg-gray-800" data-carousel-item>
                                ...
                                <p class="mb-4 text-gray-500 dark:text-gray-400">Marketing, sales & business growth for
                                    small business. Improve your marketing & promotion results - and grow your
                                    sales!</p>
