        ...
        <div class="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-8 text-center">
            ...
            <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4 mb-8">
                <p class="text-sm text-red-800 dark:text-red-200">
                    {{ __('If you believe this is an error, please contact the system administrator.') }}
                </p>
            </div>
            ...
            <div class="flex flex-col gap-3">
                ...
                <a href="{{ route('logout') }}" class="px-6 py-2 text-slate-700 dark:text-slate-300 border border-slate-300 dark:border-slate-600 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700 transition">
                    {{ __('Logout') }}
                </a>
            </div>
        </div>
