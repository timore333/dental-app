    ...
    <div class="py-3 px-3 lg:px-5 lg:pl-3">
        <div class="flex justify-between items-center">
            <div class="flex justify-start items-center">
              ...
              >{{ config('app.name', 'Dental Center') }}</span
              >
                </a>
                <form action="#" method="GET" class="hidden lg:block lg:pl-8">
                    ...
                    <div class="relative mt-1 lg:w-80">
                        ...
                        <input
                            ...
                            name="email"
                            id="topbar-search"
                            class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-2 focus:ring-fuchsia-50 focus:border-fuchsia-300 block w-full pl-10 p-2.5 mr-3"
                            placeholder="Search"
                        />
                    </div>
                </form>
                    ...
                    >
                        <div class="py-3 px-4" role="none">
                            ...
                            <p
                                ...
                                role="none"
                            >
                                <a href="#" data-cfemail="b3ddd6dadf9dc0dadec0f3d5dfdcc4d1dac7d69dd0dcde">[email&#160;protected]</a>
                            </p>
                        </div>
