<aside
    class="fixed {{ App::isLocale('ar') ? 'right-0' : 'left-0' }} top-0 h-screen w-64 bg-gradient-to-b from-slate-900 to-slate-800 text-white shadow-lg overflow-y-auto">

    <!-- Logo -->
    <div class="p-6 border-b border-slate-700">
        <h1 class="text-2xl font-bold text-teal-400">{{ __('Dental Clinic') }}</h1>
    </div>
    ...
    <nav class="mt-6">
        ...
        <a href="{{ route('dashboard') }}"
           class="flex items-center px-6 py-3 text-gray-300 hover:bg-slate-700 hover:text-white transition @if(request()->routeIs('dashboard')) bg-slate-700 text-white @endif">
            <svg class="w-5 h-5 {{ App::isLocale('ar') ? 'ml-3' : 'mr-3' }}" fill="currentColor" viewBox="0 0 20 20">
                <path
                    d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zm0 7a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zm8-1h4a1 1 0 011 1v6a1 1 0 01-1 1h-4a1 1 0 01-1-1v-6a1 1 0 011-1z"></path>
            </svg>
        ...
        <div class="mt-4">
            <button
                class="w-full flex items-center px-6 py-2 text-gray-300 hover:bg-slate-700 hover:text-white transition"
                onclick="toggleMenu('patients-menu')">
                <svg class="w-5 h-5 {{ App::isLocale('ar') ? 'ml-3' : 'mr-3' }}" fill="currentColor"
                     viewBox="0 0 20 20">
                ...
                <svg class="w-4 h-4 {{ App::isLocale('ar') ? 'mr-auto' : 'ml-auto' }}" id="patients-arrow"
        ...
        <a href="{{ route('appointments.index') }}"
           class="flex items-center px-6 py-3 text-gray-300 hover:bg-slate-700 hover:text-white transition @if(request()->routeIs('appointments.index')) bg-slate-700 text-white @endif">
            <svg class="w-5 h-5 {{ App::isLocale('ar') ? 'ml-3' : 'mr-3' }}" fill="currentColor" viewBox="0 0 20 20">
                <path
                    d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v2h16V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5H4v8a2 2 0 002 2h12a2 2 0 002-2V7h-2v1a1 1 0 11-2 0V7H9v1a1 1 0 11-2 0V7H6v1a1 1 0 11-2 0V7z"></path>
            </svg>
        ...
        <div class="mt-2">
            <button
                ...
                <svg class="w-5 h-5 {{ App::isLocale('ar') ? 'ml-3' : 'mr-3' }}" fill="currentColor"
                     viewBox="0 0 20 20">
                    <path fill-rule="evenodd"
                          d="M4 4a2 2 0 00-2 2v4a1 1 0 001 1h14a1 1 0 001-1V6a2 2 0 00-2-2H4zm0 12a2 2 0 00-2 2v.5a.5.5 0 00.5.5h15a.5.5 0 00.5-.5V18a2 2 0 00-2-2H4z"></path>
                </svg>
                <span>{{ __('Insurance') }}</span>
                <svg class="w-4 h-4 {{ App::isLocale('ar') ? 'mr-auto' : 'ml-auto' }}" id="insurance-arrow"
                     fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd"
                          d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                          clip-rule="evenodd"></path>
        ...
        <a href="{{ route('procedures.index') }}"
           class="flex items-center px-6 py-3 mt-2 text-gray-300 hover:bg-slate-700 hover:text-white transition @if(request()->routeIs('procedures.index')) bg-slate-700 text-white @endif">
            <svg class="w-5 h-5 {{ App::isLocale('ar') ? 'ml-3' : 'mr-3' }}" fill="currentColor" viewBox="0 0 20 20">
                <path
                    d="M4 4a2 2 0 012-2h8a2 2 0 012 2v12a1 1 0 110 2h-3a1 1 0 01-1-1v-2a1 1 0 00-1-1H9a1 1 0 00-1 1v2a1 1 0 01-1 1H4a1 1 0 110-2V4zm3 1h2v2H7V5zm2 4H7v2h2V9zm2-4h2v2h-2V5zm2 4h-2v2h2V9z"></path>
            </svg>
    ...
    <div class="absolute bottom-0 w-full border-t border-slate-700 bg-slate-800 p-4">
        <div class="flex items-center mb-4">
            ...
            <div class="{{ App::isLocale('ar') ? 'mr-3' : 'ml-3' }}">
