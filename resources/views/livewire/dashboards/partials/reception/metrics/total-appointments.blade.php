 <div class="bg-white shadow-lg shadow-gray-200 rounded-2xl p-4 ">
                ...
                <div class="flex items-center">
                    ...
                    <div class="flex-shrink-0 ml-3">
                        <span
                            class="text-2xl font-bold leading-none text-gray-900">{{ $metrics['total_appointments'] ?? 0 }}</span>
                        <h3 class="text-base font-normal text-gray-500">{{ __('Total Appointments') }}</h3>
                    </div>
