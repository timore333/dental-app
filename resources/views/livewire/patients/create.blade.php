<main>
    <div class="grid grid-cols-1 px-4 pt-6 xl:grid-cols-3 xl:gap-6">
        ...
        @if (session()->has('message'))
            <div
                class="bg-white dark:bg-slate-800 rounded-xl shadow-lg border-l-4 border-green-500 p-4 flex items-center gap-3">
                <svg class="w-6 h-6 text-green-500 dark:text-green-400 flex-shrink-0" fill="none" stroke="currentColor"
                     viewBox="0 0 24 24">
