...
class StorePatientRequest extends FormRequest
{
    ...
    /**
     * Prepare the data for validation by removing insurance fields when type is cash
     */
    protected function prepareForValidation(): void
    {
        // If payment type is cash, remove insurance fields before validation
    ...
    public function rules(): array
    {
        return [
            ...
            // These will ONLY be validated if type === 'insurance'
            'insurance_company_id' => 'required_if:type,insurance|nullable|exists:insurance_companies,id',
            'insurance_card_number' => 'required_if:type,insurance|nullable|string|max:50',
            'insurance_policyholder' => 'required_if:type,insurance|nullable|string|max:100',
            'insurance_expiry_date' => 'required_if:type,insurance|nullable|date|after:today',
