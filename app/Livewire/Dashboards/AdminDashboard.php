...
class AdminDashboard extends Component
{
    ...
    public function getMetrics()
    {
        return [
            ...
            'total_appointments' => Appointment::whereBetween('appointment_date', [$this->fromDate, $this->toDate])->count(),
            ...
            'pending_approvals' => \DB::table('insurance_requests')->where('status', 'pending')->count(),
            'overdue_bills' => \DB::table('patient_accounts')
                ->where('balance', '>', 0)
